...
tst_example: |
  ...
  hdef testset BloodPressureValidationTests
    ...
    def test TEST_MEAS_001_ACCURACY
      ...
      expected "All readings within ±3 mmHg of reference values"
...
req_example: |
  ...
  hdef requirementset SafetyRequirements
    ...
    def requirement REQ_AccuracyLimit
      ...
      text "Blood pressure readings shall be accurate within ±3 mmHg or ±2% of reading"
      priority "critical"
      verification "test"
...
tst_example: |
  ...
  hdef testset AccuracyValidationTests
    ...
    def test TEST_AccuracyValidation
      ...
      expected "All readings within ±3 mmHg tolerance"
      duration "2 hours"
